...
* understand what is the problem / research question tackled by the thesis (and explain why it is relevant)
...
You can use the guidelines of UniLi for the generic structure of an Expose, and/or adhere to the LaTeX template that has already been provided to you. At a high-level, there are four "crucial" sections that allow to determine whether a student will (or will not) be able to make a good job:
...
* The Problem Statement / Contribution / Research Question. Here, the student should explicitly mention what is the expected contribution of the thesis.
